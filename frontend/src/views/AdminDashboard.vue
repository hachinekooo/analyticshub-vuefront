        ...
        <el-row :gutter="20">
          <el-col :span="12">
             <el-form-item label="Project ID">
              <el-input v-model="form.project_id" :disabled="isEdit" placeholder="e.g. demo_project" />
            </el-form-item>
          </el-col>
           <el-col :span="12">
            <el-form-item label="Project Name">
              <el-input v-model="form.project_name" placeholder="e.g. Demo App" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
             <el-form-item label="Database Name">
              <el-input v-model="form.db_name" placeholder="e.g. demo_project" />
            </el-form-item>
          </el-col>
           <el-col :span="12">
